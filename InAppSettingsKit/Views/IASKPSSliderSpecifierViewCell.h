...
@property (nonatomic, strong, readonly) IASKSlider    *slider;
@property (nonatomic, strong, readonly) UIImageView *minImage;
@property (nonatomic, strong, readonly) UIImageView *maxImage;
